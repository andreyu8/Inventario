...
public class DetailTransactionDevListitemRenderer  extends EditableListitemRenderer{
	
	private Integer idStatusMovimiento;
	
	public DetailTransactionDevListitemRenderer(Integer idStatusMovimiento) {
		super();
	...
	public void render(Listitem listitem, Object data, int index) throws Exception {
		...
		Action action = new Action() {
			public void execute() {		
				DevolucionesController  devolucionesController = (DevolucionesController)SpringUtil.getBean("devolucionesController");
				devolucionesController.saveOrUpdateDevolucionAlmacen (editListitem, idStatusMovimiento);
			}
		}; 
