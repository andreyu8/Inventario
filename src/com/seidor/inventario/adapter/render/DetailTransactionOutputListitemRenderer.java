...
public class DetailTransactionOutputListitemRenderer  extends EditableListitemRenderer{
	
	private Integer idStatusMovimiento;
	
	public DetailTransactionOutputListitemRenderer(Integer idStatusMovimiento) {
		super();
	...
	public void render(Listitem listitem, Object data, int index) throws Exception {
		...
		Action action = new Action() {
			public void execute() {		
				TransactionController  transactionController = (TransactionController)SpringUtil.getBean("transactionController");
				transactionController.saveOrUpdateSalidasAlmacen (editListitem, idStatusMovimiento);
			}
		}; 
